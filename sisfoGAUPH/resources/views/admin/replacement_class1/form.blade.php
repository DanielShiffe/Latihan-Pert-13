...
<div class="form-group {{ $errors->has('jadwal_kuliah') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="jadwal_kuliah" type="date" id="jadwal_kuliah" value="{{ isset($replacement_class->jadwal_kuliah) ? $replacement_class->jadwal_kuliah : ''}}" >
...
<div class="form-group {{ $errors->has('jam_kuliah') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="jam_kuliah" type="time" id="jam_kuliah" value="{{ isset($replacement_class->jam_kuliah) ? $replacement_class->jam_kuliah : ''}}" >
...
<div class="form-group {{ $errors->has('alasan') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="alasan" type="text" id="alasan" value="{{ isset($replacement_class->alasan) ? $replacement_class->alasan : ''}}" >
